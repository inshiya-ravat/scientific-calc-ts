 ...
 */
export function updateNodeList(nodeList:NodeListOf<HTMLElement> , property:string, value:string){
 ...
 */
export function updateExpressionAndDisplay(expContent:string,displayContent:string){
